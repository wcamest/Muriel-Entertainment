...
const Catalogo = (props: Props) => {
  return (
    <div
      className="relative mt-14 lg:mt-0 p-5 lg:py-20 w-screen bg-muriel h-screen flex justify-center items-center"
    >
      <div className="fixed lg:absolute w-screen h-screen lg:w-full lg:h-full overflow-hidden">
